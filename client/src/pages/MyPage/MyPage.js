...
import { BodyContainer,InfoTextBox, ImageBox, Image, Text, ImageTextBox, 
  ChangeImage, NickNameBox, NickNameText, ChangeBtn, EmailBox , EmailText, PassWordBox, PassWordText, PwErrText} from "./MyPage.Styled";
  ...
  return <div>
    ...
    <InfoTextBox>기본회원 정보</InfoTextBox>
      ...
      <PassWordBox>
        ...
        {pwChange && <ChangeBtn onClick={cancelChange}>취소</ChangeBtn>}
        {pwErr && <PwErrText>비밀번호는 7글자이상 20글자 이하이며 영문자,숫자,특수문자가 각각
                1개이상 포함되어야 합니다.</PwErrText>}        
      </PassWordBox>
      <button onClick={submitHandle}>수정하기</button>
